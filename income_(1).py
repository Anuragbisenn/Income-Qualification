...
Original file is located at
    https://colab.research.google.com/drive/1k6cFp3gNpQSx9bdI2ByVcKeYO3FBRxhW
...
df_income_train = pd.read_csv("/content/drive/MyDrive/simplilearn/machine learnig/project2/train.csv")
df_income_test =  pd.read_csv('/content/drive/MyDrive/simplilearn/machine learnig/project2/test.csv')
...
"""# lets see all fetures in training dataset and null values accurance"""

int_Type=df_income_train.select_dtypes(np.int64).columns
...
float_type=df_income_train.select_dtypes(np.float64).columns
...
obj_type=df_income_train.select_dtypes(np.object).columns
...
import signal # for keybord iterimput error
